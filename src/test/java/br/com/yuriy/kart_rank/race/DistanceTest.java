...
public class DistanceTest {
	...
	@Test
	public void calculateTimeBetweenSecondPilotAndFirst() {
		Duration expectedTime = Duration.parse("PT5.583S");

		Race raceImp = new RaceImp(turns, pilots);
		Pilot pilot1 = new PilotMock(33, "");
		Pilot pilot2 = raceImp.findWinnerPilot();

		Duration distance = raceImp.calculateDistanceBetweenPilots(pilot1, pilot2);
		assertEquals(expectedTime, distance);
	}

	@Test
	public void calculateTimeBetweenWinnerAndANotCompletedRacePilot() {
		Duration expectedTime = Duration.parse("PT2M40.754S");

		Race raceImp = new RaceImp(turns, pilots);
		Pilot pilot1 = new PilotMock(11, "");
		Pilot pilot2 = raceImp.findWinnerPilot();
	...
	public void calculateTimeBetweenPilotOutOfRaceAndPilotInRace() {
		Race raceImp = new RaceImp(turns, pilots);
		Pilot pilot1 = new PilotMock(33, "");
		Pilot pilot2 = new PilotMock(0, "");

		raceImp.calculateDistanceBetweenPilots(pilot1, pilot2);
	}
