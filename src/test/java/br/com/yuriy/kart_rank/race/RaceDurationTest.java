...
public class RaceDurationTest {
	...
	public void calculateUnfinishedRaceDuration() {
		Pilot pilot = new PilotMock(1, "Ricardo(Slow)");
		...
		Race raceImp = new RaceImp(Arrays.asList(turn), Arrays.asList(pilot));
		raceImp.calculateRaceDuration();
	}

	@Test
	public void fourMinutesElevenSecondsFiveHundredSeventyEightMillisecondsRaceDuration() {
		Duration expectedDuration = Duration.parse("PT4M11.578S");
		Race raceImp = new RaceImp(turns, pilots);
